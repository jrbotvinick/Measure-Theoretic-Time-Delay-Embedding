...
- `generate_embedding_prediction.py`: The same as `generate_embedding.py`, except the training/testing split is based on the delay trajectory of a single observable, rather than the delay state and full state.
...
- `train_pointwise_measure_prediction`: Learns the delay-coordinate dynamics using either the measure-based or pointwise comparisons.
